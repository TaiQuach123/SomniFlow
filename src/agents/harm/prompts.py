harm_task_handler_prompt = (
    "You are the Task Handler of the Harm Agent. Your role is to generate effective sub-queries that help retrieve "
...
harm_evaluator_prompt = (
    "You are a component within the Harm Agent, which is responsible for collecting sufficient, relevant information "
    ...
    "```\n"
    "- Previous Filtered Context (if any): a block of information previously extracted and filtered by the Harm Agent in earlier attempts to answer the task.\n\n"
    "Your objectives:\n"
    ...
    "to support the Harm Agent in fulfilling the task.\n"
