factor_task_handler_prompt = (
    "You are the Task Handler of the Factor Agent. Your role is to generate effective sub-queries that help retrieve "
...
factor_evaluator_prompt = (
    "You are a component within the Factor Agent, which is responsible for collecting sufficient, relevant information "
    ...
    "```\n"
    "- Previous Filtered Context (if any): a block of information previously extracted and filtered by the Factor Agent in earlier attempts to answer the task.\n\n"
    "Your objectives:\n"
    ...
    "to support the Factor Agent in fulfilling the task.\n"
